...
public class JavaRWiiCode extends Generator
{
  /**
  ...
  */
  ...
  static void generateSingle(Table table, Proc proc, PrintWriter outData)
  {
    ...
    String tabProc;
    if (proc.isStdExtended())
      tabProc = table.useName() + "Tab." + table.useName();
    else
      tabProc = table.useName() + "Tab." + proc.upperFirst();
    outData.println("    " + tabProc + " cursor = new " + tabProc + "(_connector);");
    outData.println("    boolean has = cursor." + proc.lowerFirst() + "(rec);");
    outData.println("    if (has == true)");
    outData.println("      result = rec;");
    if (proc.hasUpdates)
  ...
  static void generateAction(Table table, Proc proc, PrintWriter outData)
  {
    ...
    if (hasInput)
    {
      ...
      if (proc.isStdExtended())
        ...
        tabProc = table.useName() + "Tab." + proc.upperFirst();
      outData.println("    " + tabProc + " cursor = new " + tabProc + "(_connector);");
      outData.println("    cursor." + proc.lowerFirst() + "(rec);");
    }
    else
  ...
  static void generateBulkAction(Table table, Proc proc, PrintWriter outData)
  {
    ...
    if (hasInput)
    {
      ...
      if (proc.isStdExtended())
        ...
        tabProc = table.useName() + "Tab." + proc.upperFirst();
      outData.println("    " + tabProc + " cursor = new " + tabProc + "(_connector);");
      outData.println("    cursor." + proc.lowerFirst() + "(recs);");
    }
    else
      outData.println("    " + table.useName() + "Tab." + proc.lowerFirst() + "(_connector);");
    outData.println("    _connector.flagCommit();");
