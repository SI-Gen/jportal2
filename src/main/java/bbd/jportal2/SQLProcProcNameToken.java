...
/** Lines of SQL Code */
public class SQLProcProcNameToken implements ISQLProcToken, Serializable
{
  ...
  public SQLProcProcNameToken(String l)
  {
    value = l;
    isVar = false;
  }
  /** Constructs line used in variable substitution */
  public SQLProcProcNameToken(String l, boolean t)
  {
    value = l;
    isVar = t;
  }
