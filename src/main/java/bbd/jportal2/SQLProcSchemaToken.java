...
/** Lines of SQL Code */
public class SQLProcSchemaToken implements ISQLProcToken, Serializable
{
  ...
  public SQLProcSchemaToken(String l)
  {
    value = l;
    isVar = false;
  }
  /** Constructs line used in variable substitution */
  public SQLProcSchemaToken(String l, boolean t)
  {
    value = l;
    isVar = t;
  }
  ...
  public String getDecoratedLine(JPortalTemplateOutputOptions options) {
    return options.SchemaNamePrefix + value + options.SchemaNameSuffix;
  }
